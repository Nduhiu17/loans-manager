...
function atable() {
    let tableButton = '#deactivated-user-group-table';
    let tableBtns = [
        {
            text: 'Clear Filters',
...
class DeactivatedUserGroupTable extends React.Component {
    ...
    render() {
        return (
                <Card.Body>
                    <Table ref="tbl" striped hover responsive bordered className="table table-condensed" id="deactivated-user-group-table">
                        <thead>
                        <tr>
                            <th>Role Name</th>
                            <th>Description</th>
...
export default DeactivatedUserGroupTable;