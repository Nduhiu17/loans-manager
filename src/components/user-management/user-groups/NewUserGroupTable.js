...
function atable() {
    let tableButton = '#new-user-group-table';
    let tableBtns = [
        {
            text: 'Clear Filters',
...
class NewUserGroupTable extends React.Component {
    ...
    render() {
        return (
                <Card.Body>
                    <Table ref="tbl" striped hover responsive bordered className="table table-condensed" id="new-user-group-table">
                        <thead>
                        <tr>
                            <th>Role Name</th>
                            <th>Description</th>
...
export default NewUserGroupTable;